...
namespace CloudBankTester
{
    ...
    public class CloudBankUtils 
    {
        ...
        ///<summary>Calls the CloudBank's show_coins service for the server that this object holds the keys for.</summary>
        ...
        ///<summary>Calls the echo service from the CloudBank server that this object holds the keys for.</summary>
        ///outputs the results to console.out
        ...
        ///<summary>Calls the print_welcome service from the CloudBank server that this object holds the keys for.</summary>
        ///outputs the results to console.out
        ...
        ///<summary>Sends the CloudCoin in rawStackForDeposit to the CloudBank server that this object holds the keys for</summary>
        ///<param name="memo">Optional note or memo to be sent with the coin</param> 
        ///loadStackFromFile needs to be called first
        public async Task sendStackToCloudBank(string memo = "Sent with C# SDK")
        {
            if (!haveKeys)
            {
                Console.Out.WriteLine("Keys not found");
        ...
        ///<param name="memo">Optional note or memo to be sent with the coin</param> 
        //loadStackFromFile needs to be called first
        public async Task sendStackToCloudBank(string toPublicURL, string memo = "Sent with C# SDK")
        {
            if (!haveKeys)
            {
                Console.Out.WriteLine("Keys not found");
        ...
        ///<summary>Retrieve the receipt generated by the CloudBank for the last call that sends back a receipt id</summary>
        ...
        ///<summary>Retrieves CloudCoins from CloudBank server that this object holds the keys for.</summary>
        ...
        ///<param name="memo">Optional note or memo to be sent with the coin</param> 
        public async Task getStackFromCloudBank( int amountToWithdraw, string memo = "Sent to C# SDK")
        {
            if (!haveKeys)
            {
                Console.Out.WriteLine("Keys not found");
            ...
            var formContent = new FormUrlEncodedContent(new[] { new KeyValuePair<string,string>("amount",amountToWithdraw.ToString()),
                new KeyValuePair<string, string>("pk", keys.privatekey), new KeyValuePair<string, string>("account", keys.account) ,new KeyValuePair<string, string>("memo", memo)});
            try
            {
        ...
        /// </summary>
        /// <param name="amountToSend">The amount of CloudCoins to be sent to the Skywallet</param>
        /// <param name="skywalletDestination">The address of the skywallet you are sending coins to. Should be in [name].skywallet.cc format</param>
        ...
        /// <summary>
        /// Downloads all the coin in the Skywallet set in your CloudBank's settings to a local wallet. This is will return that the process has started but not the results.
        /// </summary>
        ...
        /// </summary>
        /// <param name="amountToSend">The amount of CloudCoins to be transfered to the Skywallet</param>
        /// <param name="skywalletDestination">The address of the skywallet you are sending coins to. Should be in [name].skywallet.cc format</param>
